...
@SpringBootTest
class V1OrderServiceTest {

	@Autowired
	private V1OrderService orderService;
	...
	@Test
	@DisplayName("동시에 1,000개 주문 요청 시 재고가 0이 되어야 한다")
	void concurrency_test() throws InterruptedException {
		...
		// 실제(현재 코드): Race Condition으로 인해 0이 아닌 숫자가 나옴 (테스트 실패)
